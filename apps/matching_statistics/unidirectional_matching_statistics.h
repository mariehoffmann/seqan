...
template <typename container_t = String<Dna>>
struct MS
{
private:
...
protected:
    ...
    // TODO: how to get inner value_type, TValue in seqan2, container_t::Type or value_type does not work
    using alphabet_t = Dna;
...
*/
    struct source_t
    {
        // absolute path inclusive
        // tmp file directory
        // TODO: boost fs does not link
        //fs::path full_path = fs::system_complete(".");
        SeqFileIn filename;

        //SeqFileIn filename_rev = "";
...
*/
    // fwd and rev sequences
    std::array<source_t, 2> srcs = source_t{SeqFileIn{}, SeqFileIn{}}; //{fs::path{}}, source_t{fs::path{}}};
...
// todo: return path obj
    void get_base_path() const
    {
